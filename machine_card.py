...
class ShiftCell(QFrame):
    ...
    def __init__(self, label_text: str):
        ...
        self.oee_value.setFont(QFont("Segoe UI", 26, QFont.Weight.Black))
        ...
        self.downtime.setFont(QFont("Consolas", 13, QFont.Weight.Bold))
...
class MachineCard(QFrame):
    ...
    def _build_ui(self):
        ...
        self.name_label.setFont(QFont("Segoe UI", 22 if self.compact else 34, QFont.Weight.Black))
        ...
        self.oee_box.setMinimumHeight(240)
        ...
        oee_label.setFont(QFont("Segoe UI", 24, QFont.Weight.Bold))
        oee_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.oee_value = QLabel("0.0%")
        self.oee_value.setFont(QFont("Segoe UI", 30 if self.compact else 46, QFont.Weight.Black))
        self.oee_value.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.total_downtime.setFont(QFont("Consolas", 16 if self.compact else 24, QFont.Weight.Bold))
        ...
        shifts_row.setSpacing(16)
        self.shift1 = ShiftCell("Shift 1")
        self.shift2 = ShiftCell("Shift 2")
        self.shift3 = ShiftCell("Shift 3")
